...
static GtkItemFactoryEntry mainwin_entries[] =
{
	...
	{N_("/_File/_Folder/Create _new folder..."),
						NULL, (GtkItemFactoryCallback) new_folder_cb, 0, NULL},
	{N_("/_File/_Folder/_Rename folder..."),NULL, (GtkItemFactoryCallback) rename_folder_cb, 0, NULL},
	{N_("/_File/_Folder/_Move folder..."),  NULL, (GtkItemFactoryCallback) move_folder_cb, 0, NULL},
	{N_("/_File/_Folder/_Delete folder"),	NULL, (GtkItemFactoryCallback) delete_folder_cb, 0, NULL},
	{N_("/_File/_Mailbox"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_File/_Mailbox/Add _mailbox..."),	NULL, (GtkItemFactoryCallback) add_mailbox_cb, 0, NULL},
	{N_("/_File/_Mailbox/_Remove mailbox"),	NULL, (GtkItemFactoryCallback) remove_mailbox_cb, 0, NULL},
	{N_("/_File/_Mailbox/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_File/_Mailbox/_Check for new messages"),
						NULL, (GtkItemFactoryCallback) update_folderview_cb, 0, NULL},
	{N_("/_File/_Mailbox/Check for new messages in _all mailboxes"),
						NULL, (GtkItemFactoryCallback) update_folderview_cb, 1, NULL},
	{N_("/_File/_Mailbox/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_File/_Mailbox/R_ebuild folder tree"),
						NULL, (GtkItemFactoryCallback) rebuild_tree_cb, 0, NULL},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_File/_Import mail data..."),	NULL, (GtkItemFactoryCallback) import_mail_cb, 0, NULL},
	{N_("/_File/_Export mail data..."),	NULL, (GtkItemFactoryCallback) export_mail_cb, 0, NULL},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_File/Empty all _trash"),		NULL, (GtkItemFactoryCallback) empty_trash_cb, 0, NULL},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_File/_Save as..."),		"<control>S", (GtkItemFactoryCallback) save_as_cb, 0, NULL},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
#if GTK_CHECK_VERSION(2, 10, 0)
	{N_("/_File/Page set_up..."),		NULL, (GtkItemFactoryCallback) page_setup_cb, 0, NULL},
#endif
	{N_("/_File/_Print..."),		NULL, (GtkItemFactoryCallback) print_cb, 0, NULL},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_File/_Work offline"),		NULL, (GtkItemFactoryCallback) toggle_offline_cb, 0, "<ToggleItem>"},
	{N_("/_File/---"),			NULL, NULL, 0, "<Separator>"},
	/* {N_("/_File/_Close"),		"<alt>W", (GtkItemFactoryCallback) app_exit_cb, 0, NULL}, */
	{N_("/_File/E_xit"),			"<control>Q", (GtkItemFactoryCallback) app_exit_cb, 0, NULL},

	{N_("/_Edit"),				NULL, NULL, 0, "<Branch>"},
	{N_("/_Edit/_Copy"),			"<control>C", (GtkItemFactoryCallback) copy_cb, 0, NULL},
	{N_("/_Edit/Select _all"),		"<control>A", (GtkItemFactoryCallback) allsel_cb, 0, NULL},
	{N_("/_Edit/Select _thread"),		NULL, (GtkItemFactoryCallback) select_thread_cb, 0, NULL},
	{N_("/_Edit/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Edit/_Find in current message..."),
						"<control>F", (GtkItemFactoryCallback) search_cb, 0, NULL},
	{N_("/_Edit/_Search messages..."),	"<shift><control>F", (GtkItemFactoryCallback) search_cb, 1, NULL},
	{N_("/_Edit/_Quick search"),		"<shift><control>S", (GtkItemFactoryCallback) search_cb, 2, NULL},

	{N_("/_View"),				NULL, NULL, 0, "<Branch>"},
	{N_("/_View/Show or hi_de"),		NULL, NULL, 0, "<Branch>"},
	{N_("/_View/Show or hi_de/_Folder tree"),
						NULL, (GtkItemFactoryCallback) toggle_folder_cb, 0, "<ToggleItem>"},
	{N_("/_View/Show or hi_de/_Message view"),
						"V", (GtkItemFactoryCallback) toggle_message_cb, 0, "<ToggleItem>"},
	{N_("/_View/Show or hi_de/_Toolbar"),
						NULL, NULL, 0, "<Branch>"},
	{N_("/_View/Show or hi_de/_Toolbar/Icon _and text"),
						NULL, (GtkItemFactoryCallback) toggle_toolbar_cb, TOOLBAR_BOTH, "<RadioItem>"},
	{N_("/_View/Show or hi_de/_Toolbar/Text at the _right of icon"),
						NULL, (GtkItemFactoryCallback) toggle_toolbar_cb, TOOLBAR_BOTH_HORIZ, "/View/Show or hide/Toolbar/Icon and text"},
	{N_("/_View/Show or hi_de/_Toolbar/_Icon"),
						NULL, (GtkItemFactoryCallback) toggle_toolbar_cb, TOOLBAR_ICON, "/View/Show or hide/Toolbar/Icon and text"},
	{N_("/_View/Show or hi_de/_Toolbar/_Text"),
						NULL, (GtkItemFactoryCallback) toggle_toolbar_cb, TOOLBAR_TEXT, "/View/Show or hide/Toolbar/Icon and text"},
	{N_("/_View/Show or hi_de/_Toolbar/_None"),
						NULL, (GtkItemFactoryCallback) toggle_toolbar_cb, TOOLBAR_NONE, "/View/Show or hide/Toolbar/Icon and text"},
	{N_("/_View/Show or hi_de/_Search bar"),
						NULL, (GtkItemFactoryCallback) toggle_searchbar_cb, 0, "<ToggleItem>"},
	{N_("/_View/Show or hi_de/Status _bar"),
						NULL, (GtkItemFactoryCallback) toggle_statusbar_cb, 0, "<ToggleItem>"},
	{N_("/_View/_Customize toolbar..."),	NULL, (GtkItemFactoryCallback) toolbar_customize_cb, 0, NULL},
	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_View/Layou_t"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_View/Layou_t/_Normal"),		NULL, (GtkItemFactoryCallback) change_layout_cb, LAYOUT_NORMAL, "<RadioItem>"},
	{N_("/_View/Layou_t/_Vertical"),	NULL, (GtkItemFactoryCallback) change_layout_cb, LAYOUT_VERTICAL, "/View/Layout/Normal"},
	{N_("/_View/Separate f_older tree"),	NULL, (GtkItemFactoryCallback) separate_widget_cb, SEPARATE_FOLDER, "<ToggleItem>"},
	{N_("/_View/Separate _message view"),	NULL, (GtkItemFactoryCallback) separate_widget_cb, SEPARATE_MESSAGE, "<ToggleItem>"},
	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Sort"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_View/_Sort/by _number"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_NUMBER, "<RadioItem>"},
	{N_("/_View/_Sort/by s_ize"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_SIZE, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _date"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_DATE, "/View/Sort/by number"},
	{N_("/_View/_Sort/by t_hread date"),	NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_TDATE, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _from"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_FROM, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _recipient"),	NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_TO, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _subject"),	NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_SUBJECT, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _color label"),
						NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_LABEL, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _mark"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_MARK, "/View/Sort/by number"},
	{N_("/_View/_Sort/by _unread"),		NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_UNREAD, "/View/Sort/by number"},
	{N_("/_View/_Sort/by a_ttachment"),
						NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_MIME, "/View/Sort/by number"},
	{N_("/_View/_Sort/D_on't sort"),	NULL, (GtkItemFactoryCallback) sort_summary_cb, SORT_BY_NONE, "/View/Sort/by number"},
	{N_("/_View/_Sort/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Sort/Ascending"),		NULL, (GtkItemFactoryCallback) sort_summary_type_cb, SORT_ASCENDING, "<RadioItem>"},
	{N_("/_View/_Sort/Descending"),         NULL, (GtkItemFactoryCallback) sort_summary_type_cb, SORT_DESCENDING, "/View/Sort/Ascending", NULL},
	{N_("/_View/_Sort/---"),                NULL, NULL, 0, "<Separator>", NULL},
	{N_("/_View/_Sort/_Attract by subject"),
	                                        NULL, (GtkItemFactoryCallback) attract_by_subject_cb, 0, NULL},
	{N_("/_View/Th_read view"),             "<control>T", (GtkItemFactoryCallback) thread_cb, 0, "<ToggleItem>"},
	{N_("/_View/E_xpand all threads"),      NULL, (GtkItemFactoryCallback) expand_threads_cb, 0, NULL},
	{N_("/_View/Co_llapse all threads"),    NULL, (GtkItemFactoryCallback) collapse_threads_cb, 0, NULL},
	{N_("/_View/Set display _item..."),     NULL, (GtkItemFactoryCallback) set_display_item_cb, 0, NULL},

	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Go to"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_View/_Go to/_Prev message"),	"P", (GtkItemFactoryCallback) prev_cb, 0, NULL},
	{N_("/_View/_Go to/_Next message"),	"N", (GtkItemFactoryCallback) next_cb, 0, NULL},
	{N_("/_View/_Go to/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Go to/P_rev unread message"),
						"<shift>P", (GtkItemFactoryCallback) prev_unread_cb, 0, NULL},
	{N_("/_View/_Go to/N_ext unread message"),
						"<shift>N", (GtkItemFactoryCallback) next_unread_cb, 0, NULL},
	{N_("/_View/_Go to/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Go to/Prev ne_w message"),	NULL, (GtkItemFactoryCallback) prev_new_cb, 0, NULL},
	{N_("/_View/_Go to/Ne_xt new message"),	NULL, (GtkItemFactoryCallback) next_new_cb, 0, NULL},
	{N_("/_View/_Go to/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Go to/Prev _marked message"),
						NULL, (GtkItemFactoryCallback) prev_marked_cb, 0, NULL},
	{N_("/_View/_Go to/Next m_arked message"),
						NULL, (GtkItemFactoryCallback) next_marked_cb, 0, NULL},
	{N_("/_View/_Go to/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Go to/Prev _labeled message"),
	                                        NULL, (GtkItemFactoryCallback) prev_labeled_cb, 0, NULL},
	{N_("/_View/_Go to/Next la_beled message"),
	                                        NULL, (GtkItemFactoryCallback) next_labeled_cb, 0, NULL},
	{N_("/_View/_Go to/---"),               NULL, NULL, 0, "<Separator>", NULL},
	{N_("/_View/_Go to/Other _folder..."),  "G", (GtkItemFactoryCallback) goto_folder_cb, 0, NULL},
	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
...
#undef CODESET_ACTION
	...
	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_View/Open in new _window"),	"<control><alt>N", (GtkItemFactoryCallback) open_msg_cb, 0, NULL},
	{N_("/_View/Mess_age source"),		"<control>U", (GtkItemFactoryCallback) view_source_cb, 0, NULL},
	{N_("/_View/All _headers"),	"<control>H", (GtkItemFactoryCallback) show_all_header_cb, 0, "<ToggleItem>"},
	{N_("/_View/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_View/_Update summary"),		"<control><alt>U", (GtkItemFactoryCallback) update_summary_cb, 0, NULL},

	{N_("/_Message"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_Message/Recei_ve"),		NULL, NULL, 0, "<Branch>"},
	{N_("/_Message/Recei_ve/Get from _current account"),
						"<control>I", (GtkItemFactoryCallback) inc_mail_cb, 0, NULL},
	{N_("/_Message/Recei_ve/Get from _all accounts"),
						"<shift><control>I", (GtkItemFactoryCallback) inc_all_account_mail_cb, 0, NULL},
	{N_("/_Message/Recei_ve/Stop receivin_g"),
						NULL, (GtkItemFactoryCallback) inc_stop_cb, 0, NULL},
	{N_("/_Message/Recei_ve/_Remote mailbox..."),
						NULL, (GtkItemFactoryCallback) rpop3_cb, 0, NULL},
	{N_("/_Message/Recei_ve/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Send queued messages"), NULL, (GtkItemFactoryCallback) send_queue_cb, 0, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/Compose _new message"),	"<control>M", (GtkItemFactoryCallback) compose_cb, 0, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Reply"),		"<control>R", (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY, NULL},
	{N_("/_Message/Repl_y to"),		NULL, NULL, 0, "<Branch>"},
	{N_("/_Message/Repl_y to/_all"),	"<shift><control>R", (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_ALL, NULL},
	{N_("/_Message/Repl_y to/_sender"),	NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_SENDER, NULL},
	{N_("/_Message/Repl_y to/mailing _list"),
						"<control>L", (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_LIST, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Forward"),		"<control><alt>F", (GtkItemFactoryCallback) reply_cb, COMPOSE_FORWARD, NULL},
	{N_("/_Message/For_ward as attachment"),
						"<shift><control><alt>F", (GtkItemFactoryCallback) reply_cb, COMPOSE_FORWARD_AS_ATTACH, NULL},
	{N_("/_Message/Redirec_t"),		NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REDIRECT, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/M_ove..."),		"<control>O", (GtkItemFactoryCallback) move_to_cb, 0, NULL},
	{N_("/_Message/_Copy..."),		"<shift><control>O", (GtkItemFactoryCallback) copy_to_cb, 0, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Mark"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_Message/_Mark/Set _flag"),	"<shift>asterisk", (GtkItemFactoryCallback) mark_cb, 0, NULL},
	{N_("/_Message/_Mark/_Unset flag"),	"U", (GtkItemFactoryCallback) unmark_cb, 0, NULL},
	{N_("/_Message/_Mark/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Mark/Mark as unr_ead"),	"<shift>exclam", (GtkItemFactoryCallback) mark_as_unread_cb, 0, NULL},
	{N_("/_Message/_Mark/Mark as rea_d"),
						NULL, (GtkItemFactoryCallback) mark_as_read_cb, 0, NULL},
	{N_("/_Message/_Mark/Mark _thread as read"),
						NULL, (GtkItemFactoryCallback) mark_thread_as_read_cb, 0, NULL},
	{N_("/_Message/_Mark/Mark all _read"),	NULL, (GtkItemFactoryCallback) mark_all_read_cb, 0, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/_Delete"),		"<control>D", (GtkItemFactoryCallback) delete_cb, 0, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/Set as _junk mail"),	"<control>J", (GtkItemFactoryCallback) junk_cb, 0, NULL},
	{N_("/_Message/Set as not j_unk mail"),	"<shift><control>J", (GtkItemFactoryCallback) junk_cb, 1, NULL},
	{N_("/_Message/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Message/Re-_edit"),		NULL, (GtkItemFactoryCallback) reedit_cb, 0, NULL},

	{N_("/_Tools"),				NULL, NULL, 0, "<Branch>"},
	{N_("/_Tools/_Address book"),		"<shift><control>A", (GtkItemFactoryCallback) addressbook_open_cb, 0, NULL},
	{N_("/_Tools/Add sender to address boo_k..."),
						NULL, (GtkItemFactoryCallback) add_address_cb, 0, NULL},
	{N_("/_Tools/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Tools/_Filter all messages in folder"),
						NULL, (GtkItemFactoryCallback) filter_cb, 0, NULL},
	{N_("/_Tools/Filter _selected messages"),
						NULL, (GtkItemFactoryCallback) filter_cb, 1, NULL},
	...
	{N_("/_Tools/Filter _junk mails in folder"),
						NULL, (GtkItemFactoryCallback) filter_junk_cb, 0, NULL},
	{N_("/_Tools/Filter junk _mails in selected messages"),
						NULL, (GtkItemFactoryCallback) filter_junk_cb, 1, NULL},
	{N_("/_Tools/---"),			NULL, NULL, 0, "<Separator>"},
#ifndef G_OS_WIN32
	...
	{N_("/_Tools/Delete du_plicated messages"),
						NULL, (GtkItemFactoryCallback) delete_duplicated_cb,   0, NULL},
	{N_("/_Tools/C_oncatenate separated messages"),
						NULL, (GtkItemFactoryCallback) concat_partial_cb, 0, NULL},
	{N_("/_Tools/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Tools/E_xecute marked process"),	"X", (GtkItemFactoryCallback) execute_summary_cb, 0, NULL},
	{N_("/_Tools/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Tools/Op_en configuration folder"),
						NULL, (GtkItemFactoryCallback) open_config_folder_cb, 0, NULL},
	{N_("/_Tools/Open a_ttachments folder"),NULL, (GtkItemFactoryCallback) open_attachments_folder_cb, 0, NULL},
	{N_("/_Tools/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Tools/_Log window"),		"<shift><control>L", (GtkItemFactoryCallback) log_window_show_cb, 0, NULL},

	{N_("/_Configuration"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_Configuration/_Common preferences..."),
						NULL, (GtkItemFactoryCallback) prefs_common_open_cb, 0, NULL},
	{N_("/_Configuration/_Filter settings..."),
						NULL, (GtkItemFactoryCallback) prefs_filter_open_cb, 0, NULL},
	{N_("/_Configuration/_Template..."),	NULL, (GtkItemFactoryCallback) prefs_template_open_cb, 0, NULL},
#ifndef G_OS_WIN32
	{N_("/_Configuration/_Actions..."),	NULL, (GtkItemFactoryCallback) prefs_actions_open_cb, 0, NULL},
#endif
	{N_("/_Configuration/Plug-in _manager..."),
						NULL, (GtkItemFactoryCallback) plugin_manager_open_cb, 0, NULL},
	{N_("/_Configuration/---"),		NULL, NULL, 0, "<Separator>"},
	{N_("/_Configuration/_Preferences for current account..."),
						NULL, (GtkItemFactoryCallback) prefs_account_open_cb, 0, NULL},
	{N_("/_Configuration/Create _new account..."),
						NULL, (GtkItemFactoryCallback) new_account_cb, 0, NULL},
	...
	{N_("/_Help/_Manual/_English"),		NULL, (GtkItemFactoryCallback) manual_open_cb, MANUAL_LANG_EN, NULL},
	{N_("/_Help/_Manual/_Japanese"),	NULL, (GtkItemFactoryCallback) manual_open_cb, MANUAL_LANG_JA, NULL},
	{N_("/_Help/_FAQ"),			NULL, NULL, 0, "<Branch>"},
	{N_("/_Help/_FAQ/_English"),		NULL, (GtkItemFactoryCallback) faq_open_cb, MANUAL_LANG_EN, NULL},
	{N_("/_Help/_FAQ/_German"),		NULL, (GtkItemFactoryCallback) faq_open_cb, MANUAL_LANG_DE, NULL},
	{N_("/_Help/_FAQ/_Spanish"),		NULL, (GtkItemFactoryCallback) faq_open_cb, MANUAL_LANG_ES, NULL},
	{N_("/_Help/_FAQ/_French"),		NULL, (GtkItemFactoryCallback) faq_open_cb, MANUAL_LANG_FR, NULL},
	{N_("/_Help/_FAQ/_Italian"),		NULL, (GtkItemFactoryCallback) faq_open_cb, MANUAL_LANG_IT, NULL},
	{N_("/_Help/_Command line options"),	NULL, (GtkItemFactoryCallback) help_cmdline_cb, 0, NULL},
#if USE_UPDATE_CHECK
	{N_("/_Help/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Help/_Update check..."),		NULL, (GtkItemFactoryCallback) update_check_cb, 0, NULL},
#ifdef USE_UPDATE_CHECK_PLUGIN
	{N_("/_Help/Update check of _plug-ins..."),
						NULL, (GtkItemFactoryCallback) update_check_plugin_cb, 0, NULL},
#endif
#endif
	{N_("/_Help/---"),			NULL, NULL, 0, "<Separator>"},
...
{
	{N_("/_Reply"),			NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY, NULL},
	{N_("/Reply to _all"),		NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_ALL, NULL},
	{N_("/Reply to _sender"),	NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_SENDER, NULL},
	{N_("/Reply to mailing _list"),	NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REPLY_TO_LIST, NULL}
};

static GtkItemFactoryEntry forward_entries[] =
{
	{N_("/_Forward"),		NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_FORWARD, NULL},
	{N_("/For_ward as attachment"), NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_FORWARD_AS_ATTACH, NULL},
	{N_("/Redirec_t"),		NULL, (GtkItemFactoryCallback) reply_cb, COMPOSE_REDIRECT, NULL}
};
