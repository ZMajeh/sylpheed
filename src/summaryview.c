...
{
	{N_("/_Reply"), NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_REPLY, NULL, NULL},
	{N_("/Repl_y to"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Branch>", NULL},
	{N_("/Repl_y to/_all"), NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_REPLY_TO_ALL, NULL, NULL},
	{N_("/Repl_y to/_sender"), NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_REPLY_TO_SENDER, NULL, NULL},
	{N_("/Repl_y to/mailing _list"), NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_REPLY_TO_LIST, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_Forward"),		NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_FORWARD, NULL, NULL},
	{N_("/For_ward as attachment"),	NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_FORWARD_AS_ATTACH, NULL, NULL},
	{N_("/Redirec_t"),		NULL, (GtkItemFactoryCallback) summary_reply_cb, COMPOSE_REDIRECT, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/M_ove..."), NULL, (GtkItemFactoryCallback) summary_move_to, 0, NULL, NULL},
	{N_("/_Copy..."), NULL, (GtkItemFactoryCallback) summary_copy_to, 0, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_Mark"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Branch>", NULL},
	{N_("/_Mark/Set _flag"), NULL, (GtkItemFactoryCallback) summary_mark, 0, NULL, NULL},
	{N_("/_Mark/_Unset flag"), NULL, (GtkItemFactoryCallback) summary_unmark, 0, NULL, NULL},
	{N_("/_Mark/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_Mark/Mark as unr_ead"),	NULL, (GtkItemFactoryCallback) summary_mark_as_unread, 0, NULL, NULL},
	{N_("/_Mark/Mark as rea_d"),
					NULL, (GtkItemFactoryCallback) summary_mark_as_read, 0, NULL, NULL},
	{N_("/_Mark/Mark _thread as read"),
					NULL, (GtkItemFactoryCallback) summary_mark_thread_as_read, 0, NULL, NULL},
	{N_("/_Mark/Mark all _read"),	NULL, (GtkItemFactoryCallback) summary_mark_all_read, 0, NULL, NULL},
	{N_("/Color la_bel"), NULL, (GtkItemFactoryCallback) NULL, 0, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_Delete"), NULL, (GtkItemFactoryCallback) summary_delete, 0, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/Set as _junk mail"), NULL, (GtkItemFactoryCallback) summary_junk, 0, NULL, NULL},
	{N_("/Set as not j_unk mail"), NULL, (GtkItemFactoryCallback) summary_not_junk, 0, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/Re-_edit"), NULL, (GtkItemFactoryCallback) summary_reedit, 0, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/Add sender to address boo_k..."),
					NULL, (GtkItemFactoryCallback) summary_add_address_cb, 0, NULL, NULL},
	{N_("/Create f_ilter rule"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Branch>", NULL},
	{N_("/Create f_ilter rule/_Automatically"),
					NULL, (GtkItemFactoryCallback) summary_create_filter_cb, FLT_BY_AUTO, NULL, NULL},
	{N_("/Create f_ilter rule/by _From"),
					NULL, (GtkItemFactoryCallback) summary_create_filter_cb, FLT_BY_FROM, NULL, NULL},
	{N_("/Create f_ilter rule/by _To"),
					NULL, (GtkItemFactoryCallback) summary_create_filter_cb, FLT_BY_TO, NULL, NULL},
	{N_("/Create f_ilter rule/by _Subject"),
					NULL, (GtkItemFactoryCallback) summary_create_filter_cb, FLT_BY_SUBJECT, NULL, NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_View"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Branch>", NULL},
	{N_("/_View/Open in new _window"), NULL, (GtkItemFactoryCallback) summary_open_msg, 0, NULL, NULL},
	{N_("/_View/Mess_age source"),	NULL, (GtkItemFactoryCallback) summary_view_source, 0, NULL, NULL},
	{N_("/_View/All _headers"), NULL, (GtkItemFactoryCallback) summary_show_all_header_cb, 0, "<ToggleItem>", NULL},
	{N_("/---"), NULL, (GtkItemFactoryCallback) NULL, 0, "<Separator>", NULL},
	{N_("/_Print..."), NULL, (GtkItemFactoryCallback) summary_print, 0, NULL, NULL}
};
