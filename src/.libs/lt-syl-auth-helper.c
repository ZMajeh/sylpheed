...
/* ./.libs/lt-syl-auth-helper.c - temporary wrapper executable for .libs/syl-auth-helper.exe
   Generated by libtool (GNU libtool) 2.5.4

   The syl-auth-helper program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\git\\sylpheed\\libsylph\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\git\\sylpheed\\libsylph\\.libs;C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;";
const char * TARGET_PROGRAM_NAME = "syl-auth-helper.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# syl-auth-helper - temporary wrapper script for .libs/syl-auth-helper.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The syl-auth-helper program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' ../libsylph/libsylph-0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"syl-auth-helper.exe:syl-auth-helper:$LINENO: libtool wrapper (GNU lib", f);
  fputs ("tool) 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"syl-auth-helper.exe:syl-auth-helper:$LINENO: newargv[$lt_dump_args_N", f);
  fputs ("]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"syl-auth-helper.exe:syl-auth-helper:$LINENO: newargv[0]: $progdi", f);
  fputs ("r\\\\$program\" 1>&2\n", f);
  ...
  fputs ("\n", f);
  fputs ("  program='syl-auth-helper.exe'\n", f);
  ...
  fputs ("    PATH=/d/git/sylpheed/libsylph/.libs:/mingw64/lib:/mingw64/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/git/sylpheed/libsylph/.libs:$PATH\"\n", f);
  fputs ("\n", f);
