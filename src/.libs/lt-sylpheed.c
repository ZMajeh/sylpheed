...
/* ./.libs/lt-sylpheed.c - temporary wrapper executable for .libs/sylpheed.exe
   Generated by libtool (GNU libtool) 2.5.4

   The sylpheed program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "D:\\git\\sylpheed\\src\\.libs;D:\\git\\sylpheed\\libsylph\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\msys64\\mingw64\\lib;C:\\msys64\\mingw64\\bin;D:\\git\\sylpheed\\src\\.libs;D:\\git\\sylpheed\\libsylph\\.libs;";
const char * TARGET_PROGRAM_NAME = "sylpheed.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# sylpheed - temporary wrapper script for .libs/sylpheed.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.5.4\n", f);
  fputs ("#\n", f);
  fputs ("# The sylpheed program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libsylpheed-plugin-0.la /d/git/sylpheed/libsylph/libsylph-0", f);
  fputs (".la ../libsylph/libsylph-0.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"sylpheed.exe:sylpheed:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"sylpheed.exe:sylpheed:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"sylpheed.exe:sylpheed:$LINENO: newargv[0]: $progdir\\\\$program\" 1", f);
  fputs (">&2\n", f);
  ...
  fputs ("    PATH=/mingw64/lib:/mingw64/bin:/d/git/sylpheed/src/.libs:/d/git/sylpheed/li", f);
  fputs ("bsylph/.libs:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/git/sylpheed/src/.libs:/d/git/sylpheed/libsylph/.libs:$PATH\"\n", f);
  fputs ("\n", f);
