...
{
	{N_("/Create _new folder..."),	NULL,  (GtkItemFactoryCallback) folderview_new_folder_cb, 0, NULL, NULL},
	{N_("/_Rename folder..."),	NULL,  (GtkItemFactoryCallback) folderview_rename_folder_cb, 0, NULL, NULL},
	{N_("/_Move folder..."),	NULL,  (GtkItemFactoryCallback) folderview_move_folder_cb, 0, NULL, NULL},
	{N_("/_Delete folder"),		NULL,  (GtkItemFactoryCallback) folderview_delete_folder_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/Empty _junk"),		NULL,  (GtkItemFactoryCallback) folderview_empty_trash_cb, 0, NULL, NULL},
	{N_("/Empty _trash"),		NULL,  (GtkItemFactoryCallback) folderview_empty_trash_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Check for new messages"),
					NULL,  (GtkItemFactoryCallback) folderview_update_tree_cb, 0, NULL, NULL},
	{N_("/R_ebuild folder tree"),	NULL,  (GtkItemFactoryCallback) folderview_update_tree_cb, 1, NULL, NULL},
	{N_("/_Update summary"),	NULL,  (GtkItemFactoryCallback) folderview_update_summary_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/Mar_k all read"),		NULL,  (GtkItemFactoryCallback) folderview_mark_all_read_cb, 0, NULL, NULL},
	{N_("/Send _queued messages"),	NULL,  (GtkItemFactoryCallback) folderview_send_queue_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/_Search messages..."),	NULL,  (GtkItemFactoryCallback) folderview_search_cb, 0, NULL, NULL},
	{N_("/Ed_it search condition..."),
					NULL,  (GtkItemFactoryCallback) folderview_search_cb, 0, NULL, NULL},
	{N_("/_Properties..."),		NULL,  (GtkItemFactoryCallback) folderview_property_cb, 0, NULL, NULL}
};
...
static GtkItemFactoryEntry folderview_imap_popup_entries[] =
{
	...
	{N_("/Empty _trash"),		NULL,  (GtkItemFactoryCallback) folderview_empty_trash_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>", NULL},
	{N_("/Down_load"),		NULL,  (GtkItemFactoryCallback) folderview_download_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>", NULL},
	{N_("/_Check for new messages"),
					NULL,  (GtkItemFactoryCallback) folderview_update_tree_cb, 0, NULL, NULL},
	{N_("/R_ebuild folder tree"),	NULL,  (GtkItemFactoryCallback) folderview_update_tree_cb, 1, NULL, NULL},
...
static GtkItemFactoryEntry folderview_news_popup_entries[] =
{
	{N_("/Su_bscribe to newsgroup..."),
					NULL,  (GtkItemFactoryCallback) folderview_new_news_group_cb, 0, NULL, NULL},
	{N_("/_Remove newsgroup"),	NULL,  (GtkItemFactoryCallback) folderview_rm_news_group_cb, 0, NULL, NULL},
	{N_("/_Rename folder..."),	NULL,  (GtkItemFactoryCallback) folderview_rename_folder_cb, 0, NULL, NULL},
	{N_("/_Delete folder"),		NULL,  (GtkItemFactoryCallback) folderview_delete_folder_cb, 0, NULL, NULL},
	{N_("/---"),			NULL, NULL, 0, "<Separator>"},
	{N_("/Down_load"),		NULL,  (GtkItemFactoryCallback) folderview_download_cb, 0, NULL, NULL},
